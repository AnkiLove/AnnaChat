...
public final class ConfigManager {
    ...
    public RuntimeConfig load(TextService textService) {
        ...
        return new RuntimeConfig(
                ...
                mainFile.getString("formatting.gradient-permission", "annachat.chat.gradient"),
                mainFile.getString("formatting.rainbow-permission", "annachat.chat.rainbow"),
                mainFile.getString("formatting.transition-permission", "annachat.chat.transition"),
