...
public final class ConfigManager {
    ...
    private void migrateLegacyColorPermissions() {
        ...
        SparrowYamlConfiguration main = SparrowYamlConfiguration.loadConfiguration(mainFile);
    ...
    private void migrateLegacyTitles() {
        ...
        SparrowYamlConfiguration main = SparrowYamlConfiguration.loadConfiguration(mainFile);
            SparrowYamlConfiguration titles = SparrowYamlConfiguration.loadConfiguration(titleFile);
    ...
    private void migrateLegacyMentionInteraction() {
        ...
        SparrowYamlConfiguration interactions = SparrowYamlConfiguration.loadConfiguration(interactionFile);
    ...
    private void migrateLegacyChannelDefaults() {
        ...
        File mainFile = new File(plugin.getDataFolder(), "config.yml");
        SparrowYamlConfiguration channels = SparrowYamlConfiguration.loadConfiguration(channelFile);
        SparrowYamlConfiguration formats = SparrowYamlConfiguration.loadConfiguration(formatFile);
        SparrowYamlConfiguration main = SparrowYamlConfiguration.loadConfiguration(mainFile);
        ...
        if (legacyChannelLayout) {
            SparrowYamlConfiguration bundledChannels = loadBundled("channels.yml");
            ...
            SparrowYamlConfiguration bundledFormats = loadBundled("formats.yml");
     ...
     * 意外重写服务器的视觉配置。
     */
    private static void migrateDefaultFormatColors(SparrowYamlConfiguration formats) {
    ...
    private static void replaceExactInFormatPart(SparrowYamlConfiguration configuration, String formatId, int partIndex,
    ...
    private SparrowYamlConfiguration loadBundled(String name) {
        try (InputStream input = Objects.requireNonNull(plugin.getResource(name), "JAR 内缺少 " + name);
             InputStreamReader reader = new InputStreamReader(input, StandardCharsets.UTF_8)) {
            return SparrowYamlConfiguration.loadConfiguration(reader);
        } catch (IOException exception) {
            throw new IllegalStateException("读取 JAR 内默认 " + name + " 失败", exception);
        }
    }

    private static void copySection(SparrowYamlConfiguration source, SparrowYamlConfiguration target, String path) {
    ...
    public RuntimeConfig load(TextService textService) {
        SparrowYamlConfiguration mainFile = loadFile("config.yml");
        SparrowYamlConfiguration channelsFile = loadFile("channels.yml");
        SparrowYamlConfiguration formatsFile = loadFile("formats.yml");
        SparrowYamlConfiguration interactionsFile = loadFile("interactions.yml");
        SparrowYamlConfiguration filtersFile = loadFile("filters.yml");
        SparrowYamlConfiguration moderationFile = loadFile("moderation.yml");
        SparrowYamlConfiguration messagesFile = loadFile("messages.yml");
        SparrowYamlConfiguration placeholdersFile = loadFile("placeholders.yml");
        SparrowYamlConfiguration databaseFile = loadFile("database.yml");
        SparrowYamlConfiguration titlesFile = loadFile("titles.yml");
        SparrowYamlConfiguration groupsFile = loadFile("groups.yml");
    ...
    private SparrowYamlConfiguration loadFile(String name) {
        SparrowYamlConfiguration configuration = SparrowYamlConfiguration.loadConfiguration(new File(plugin.getDataFolder(), name));
     ...
     */
    private void mergeMainConfigDefaults(SparrowYamlConfiguration target) {
        try (InputStream input = Objects.requireNonNull(
                plugin.getResource("config.yml"), "JAR 内缺少 config.yml");
             InputStreamReader reader = new InputStreamReader(input, StandardCharsets.UTF_8)) {
        SparrowYamlConfiguration defaults = SparrowYamlConfiguration.loadConfiguration(reader);
    ...
    private static MentionSettings loadMentionSettings(SparrowYamlConfiguration file) {
    ...
    private Map<String, ConfiguredChannel> loadChannels(SparrowYamlConfiguration file) {
    ...
    private Map<String, FormatDefinition> loadFormats(SparrowYamlConfiguration file) {
        ...
        for (String rawId : root.getKeys(false)) {
            ...
            for (Map<?, ?> raw : rawParts) {
                SparrowYamlConfiguration partConfig = new SparrowYamlConfiguration();
    ...
    private static void normalizeFormatPart(SparrowYamlConfiguration configuration) {
    ...
    private List<FormatRule> loadFormatRules(SparrowYamlConfiguration file) {
    ...
    private TitleSettings loadTitles(SparrowYamlConfiguration file) {
    ...
    private GroupSettings loadGroups(SparrowYamlConfiguration file) {
    ...
    private static Map<String, String> loadColorPermissions(SparrowYamlConfiguration file) {
    ...
    private List<ConfiguredInteraction> loadInteractions(SparrowYamlConfiguration file, TextService textService) {
    ...
    private List<ConfiguredFilter> loadFilters(SparrowYamlConfiguration file) {
     ...
     */
    private ModerationSettings loadModeration(SparrowYamlConfiguration file) {
